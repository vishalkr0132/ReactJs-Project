...
function VideoCard(props) {
  ...
  return (
    <div style={{ width: props.width, display: props.display }} className='w-[100%] sm:w-[90%] md:w-[100%] relative cursor-pointer videoComponent'>
      <img onClick={() => pageRoute(`/watch/${props.videoId}`)} className='md:w-56 lg:w-72 rounded-[12px] videoImage' src={props.thumbnail} alt="Video Thumbnail" />
      <div style={{ width: props.rightWidth }} className='flex w-[100%] gap-x-3 items-start mt-2'>
        <div>
